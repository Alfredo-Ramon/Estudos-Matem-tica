...
while True:
    while True:
        ...
        if re.fullmatch(re.compile('[1-5]'),escolhaMenuPrincipal) == None:
            ...
            print(f'\33[31m{"Por favor escolha umas das opções [1,2,3,4,5]".center(100)}\33[m')
            print('\33[41m \33[m'*100)
            print()            
        else:
            break
    ...
    if escolhaMenuPrincipal == '1':
        while True:
            ...
            if re.fullmatch(re.compile('[1-4]'),escolhaSomaDificuldade) == None:
                print()
                print('\33[41m \33[m'*100)
                print(f'\33[31m{"Por favor escolha umas das opções [1,2,3,4]".center(100)}\33[m')
                print('\33[41m \33[m'*100)
        ...
        while True:
            ...
            if re.fullmatch(re.compile('[1-3]'),escolhaMultiplicaçãoDificuldade) == None:
                print()
                print('\33[41m \33[m'*100)
                print(f'\33[31m{"Por favor escolha umas das opções [1,2,3]".center(100)}\33[m')
                print('\33[41m \33[m'*100)
        ...
        while True:
            ...
            if re.fullmatch(re.compile('[1-2]'),escolhaDivisãoDificuldade) == None :
                print()
                print('\33[41m \33[m'*100)
                print(f'\33[31m{"Por favor escolha umas das opções [1,2]".center(100)}\33[m')
                print('\33[41m \33[m'*100)
