def MenuSubtração():
    print()
    print()
    print(F'\33[35m{"Subtração".center(100)}\33[m')
...
def MenuSubtraçãoEscolha():
    ...
    print(f'\33[32m[2]: Fácil \33[m\33[31m(Negativos)\33[m')
    print(f'\33[33m[3]: Médio\33[m')
    print(f'\33[33m[4]: Médio\33[m \33[31m(Negativos)\33[m')
    print(f'\33[31m[5]: Voltar para o Menu Principal\33[m ')
    print('\33[45m \33[m'*100)
...
def SubtraçãoFacilNegativo():
    ...
    print(F'\33[35m{"Subtração".center(100)}\33[m')
    print('\33[45m \33[m'*100)
    print(F'\33[36m{"Facil: O programa ira fazer 10 contas todas contendo só uma unidade (O resultado pode ser negativo)".center(100)}\33[m')
    print('\33[45m \33[m'*100)
    print()
    print()
    for Conta in range(10):
...
def SubtraçãoMédioNegativo():
    ...
    print(F'\33[35m{"Subtração".center(100)}\33[m')
    print('\33[45m \33[m'*100)
    print(F'\33[36m{"Médio: O programa ira fazer 10 contas, contendo dezena e unidade (O resultado pode ser negativo)".center(100)}\33[m')
    print('\33[45m \33[m'*100)
    print()
    print()
    for Conta in range(10):
...
if __name__ == '__main__':
    MenuSubtração()
    MenuSubtraçãoEscolha()
    SubtraçãoFacil()
    SubtraçãoFacilNegativo()
    SubtraçãoMédio()
    SubtraçãoMédioNegativo()